...
class AdminAbilityListControllerTest {
    ...
    void testList_Success() throws Exception {
        AdminAbilityVO vo = AdminAbilityVO.builder()
                ...
                .descCn("中文描述")
                .descEn("English Desc")
                .iconUrl("/ability-files/icon-batch-1")
                .diagramUrl("/ability-files/diagram-batch-1")
                .orderNum(1)
        ...
        mockMvc.perform(get("/service/open/v2/ability/admin/list")
                ...
                .andExpect(jsonPath("$.data[0].iconUrl").value("/ability-files/icon-batch-1"))
                .andExpect(jsonPath("$.data[0].diagramUrl").value("/ability-files/diagram-batch-1"))
