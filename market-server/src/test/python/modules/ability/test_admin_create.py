...
class TestAbilityAdminCreateL1:
    ...
    @pytest.mark.L1
    def test_create_full_fields(self, api):
        """L1-1: 完整字段创建应返回 200"""
        ability_type = 999001
        try:
            body = {
    ...
    @pytest.mark.L1
    def test_create_minimal_fields(self, api):
...
class TestAbilityAdminCreateL2:
    ...
    @pytest.mark.L2
    def test_duplicate_ability_type(self, api):
    ...
    @pytest.mark.L2
    def test_load_type_2_requires_all_three(self, api):
    ...
    @pytest.mark.L2
    def test_invalid_entry_url_format(self, api):
    ...
    @pytest.mark.L2
    def test_create_with_diagram(self, api):
        """L2-4: 含示意图创建应成功"""
        ability_type = 999006
        try:
            body = {
    ...
    @pytest.mark.L2
    def test_auto_order_num(self, api):
...
class TestAbilityAdminCreateL4:
    ...
    def test_missing_required_fields(self, api):
        """L4-1: 缺少必填字段（abilityType/nameCn/descCn）应返回 400"""
        body = {}
        resp = api("POST", "/service/open/v2/ability/admin", body=body)
        assert resp is not None
        assert resp["code"] == "400"
    ...
    @pytest.mark.L4
    def test_name_cn_too_short(self, api):
    ...
    @pytest.mark.L4
    def test_desc_cn_too_short(self, api):
    ...
    @pytest.mark.L4
    def test_missing_icon_batch_id(self, api):
