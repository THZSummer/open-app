package com.xxx.it.works.wecode.v2.modules.dictionary.dto;
...
public class DictionaryCreateDTO implements Serializable {
    ...
    @Pattern(regexp = "^[a-zA-Z0-9_./*-]+$", message = "路径只支持字母、数字、下划线、点、横杠、斜杠、星号")
    @Schema(description = "路径，必填，1-100字符，支持字母、数字、下划线、点、横杠、斜杠、星号",
            requiredMode = Schema.RequiredMode.REQUIRED,
            example = "system/user")
    private String path;
