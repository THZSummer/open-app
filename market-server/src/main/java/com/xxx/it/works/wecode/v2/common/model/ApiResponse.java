...
public class ApiResponse<T> implements Serializable {
    ...
    public static <T> ApiResponse<T> success() {
        return ApiResponse.<T>builder()
                ...
                .messageZh(ResponseCodeEnum.SUCCESS.getMessageZh())
                .messageEn(ResponseCodeEnum.SUCCESS.getMessageEn())
                .build();
    }
    ...
    public static <T> ApiResponse<T> error(ResponseCodeEnum responseCode) {
        return ApiResponse.<T>builder()
                ...
                .messageZh(responseCode.getMessageZh())
     ...
     * 错误响应（自定义消息）
     */
    public static <T> ApiResponse<T> error(ResponseCodeEnum responseCode, String messageZh, String messageEn) {
        return ApiResponse.<T>builder()
                .code(responseCode.getCode())
                .messageZh(messageZh)
                .messageEn(messageEn)
