...
public interface ClassifyMapper {
     ...
     * 查询分类列表（带分页和条件）
     */
    List<ClassifyEntity> selectList(@Param("classifyCode") String classifyCode,
                                    @Param("classifyName") String classifyName,
                                    @Param("classifyDesc") String classifyDesc,
     ...
     * 统计分类总数（带条件）
     */
    long countList(@Param("classifyCode") String classifyCode,
                   @Param("classifyName") String classifyName,
                   @Param("classifyDesc") String classifyDesc,
                   @Param("status") Integer status);
     ...
     * 统计分类下的项数量
     */
    int countItemsByClassifyId(@Param("classifyId") Long classifyId);
