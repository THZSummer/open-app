...
| ID | 用户故事 | 优先级 | 验收标准 |
|----|---------|--------|---------|
| US-04 | 作为 **三方平台人员**，我想要 **将我的系统（ERP/CRM/OA 等）封装为连接器并注册到平台**，以便 **其他连接流可引用我系统提供的触发器或动作** | P0 | 三方平台人员可创建连接器，定义触发器和动作（封装自身系统的 API/Webhook），提交发布审批 |
...
| US-07 | 作为 **三方平台人员**，我想要 **浏览和使用已上架的连接器**，以便 **减少将 XX 平台能力集成到自己系统的编码工作量** | P0 | 消费方可浏览连接器目录，查看连接器包含的触发器和动作 |
| US-08 | 作为 **三方平台人员**，我想要 **通过可视化拖拽编排连接流**，以便 **无需硬编码即可串联多个能力完成业务流程** | P0 | 消费方可拖拽连接器节点到画布，配置连线关系和数据映射，形成完整连接流 |
