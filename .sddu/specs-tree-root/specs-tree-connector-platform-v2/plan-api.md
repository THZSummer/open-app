...
|:--:|------|------|--------|------|------|:--:|
| 1 | open-server | **连接器 CRUD** | POST | `/service/open/v2/connectors` | 创建连接器 | FR-001 |
| 2 | | | GET | `/service/open/v2/connectors` | 查询连接器列表（按 appId 过滤） | — |
| 3 | | | GET | `/service/open/v2/connectors/{id}` | 查询连接器详情 | — |
| 4 | | | PUT | `/service/open/v2/connectors/{id}` | 更新连接器基本信息 | — |
| 5 | | | PUT | `/service/open/v2/connectors/{id}/invalidate` | 标记连接器失效 | FR-003 |
| 6 | | | PUT | `/service/open/v2/connectors/{id}/restore` | 恢复连接器 | FR-002 |
| 7 | | | DELETE | `/service/open/v2/connectors/{id}` | 删除连接器（物理删除） | FR-004 |
| 8 | | **连接器版本** | GET | `/service/open/v2/connectors/{id}/versions` | 版本列表 | FR-008 |
| 9 | | | GET | `/service/open/v2/connectors/{id}/versions/{vid}` | 版本详情（只读快照） | FR-008 |
| 10 | | | PUT | `/service/open/v2/connectors/{id}/versions/{vid}` | 编辑草稿保存 | FR-005 |
| 11 | | | PUT | `/service/open/v2/connectors/{id}/versions/{vid}/publish` | 发布版本 | FR-007 |
| 12 | | | POST | `/service/open/v2/connectors/{id}/versions/{vid}/copy-to-draft` | 复制已发布版本到草稿 | FR-006 |
| 13 | | | PUT | `/service/open/v2/connectors/{id}/versions/{vid}/invalidate` | 标记版本失效 | FR-009 |
| 14 | | | PUT | `/service/open/v2/connectors/{id}/versions/{vid}/restore` | 恢复版本 | FR-011 |
| 15 | | | DELETE | `/service/open/v2/connectors/{id}/versions/{vid}` | 删除版本（物理删除） | FR-010 |
| 16 | | **URL 白名单** | GET | `/service/open/v2/connectors/{id}/url-whitelist` | 查询 URL 白名单规则列表 | FR-015 |
| 17 | | | POST | `/service/open/v2/connectors/{id}/url-whitelist` | 新增白名单规则 | FR-015 |
| 18 | | | DELETE | `/service/open/v2/connectors/{id}/url-whitelist/{rid}` | 删除白名单规则 | FR-015 |
| 19 | | **连接流 CRUD** | POST | `/service/open/v2/flows` | 创建连接流 | FR-016 |
| 20 | | | GET | `/service/open/v2/flows` | 查询连接流列表（按 appId 过滤） | — |
| 21 | | | GET | `/service/open/v2/flows/{id}` | 查询连接流详情 | — |
| 22 | | | PUT | `/service/open/v2/flows/{id}` | 更新连接流基本信息 | — |
| 23 | | | POST | `/service/open/v2/flows/{id}/copy` | 一键复制连接流 | FR-017 |
| 24 | | | POST | `/service/open/v2/flows/{id}/deploy` | 部署+启动（选择已发布版本） | FR-018 |
| 25 | | | POST | `/service/open/v2/flows/{id}/start` | 启动连接流 | FR-019 |
| 26 | | | POST | `/service/open/v2/flows/{id}/stop` | 停止连接流 | FR-020 |
| 27 | | | PUT | `/service/open/v2/flows/{id}/invalidate` | 标记连接流失效 | FR-022 |
| 28 | | | PUT | `/service/open/v2/flows/{id}/restore` | 恢复连接流 | FR-021 |
| 29 | | | DELETE | `/service/open/v2/flows/{id}` | 删除连接流（物理删除） | FR-023 |
| 30 | | **连接流版本** | GET | `/service/open/v2/flows/{id}/versions` | 版本列表 | FR-027 |
| 31 | | | GET | `/service/open/v2/flows/{id}/versions/{vid}` | 版本详情（只读快照） | FR-027 |
| 32 | | | PUT | `/service/open/v2/flows/{id}/versions/{vid}` | 编辑草稿保存 | FR-024 |
| 33 | | | POST | `/service/open/v2/flows/{id}/versions/{vid}/submit-approval` | 提交审批 | FR-026 |
| 34 | | | POST | `/service/open/v2/flows/{id}/versions/{vid}/copy-to-draft` | 复制已发布版本到草稿 | FR-025 |
| 35 | | | PUT | `/service/open/v2/flows/{id}/versions/{vid}/invalidate` | 标记版本失效 | FR-028 |
| 36 | | | PUT | `/service/open/v2/flows/{id}/versions/{vid}/restore` | 恢复版本 | FR-030 |
| 37 | | | DELETE | `/service/open/v2/flows/{id}/versions/{vid}` | 删除版本（物理删除） | FR-029 |
| 38 | | **运行记录** | GET | `/service/open/v2/flows/{id}/executions` | 运行记录列表（分页+过滤） | FR-042 |
| 39 | | | GET | `/service/open/v2/flows/{id}/executions/{eid}` | 运行记录详情（含节点日志） | FR-042 |
| 40 | | **审批管理** | POST | `/service/open/v2/connector-platform/approvals/{vid}/urge` | 一键催办 | FR-033 |
| 41 | | | GET | `/service/open/v2/connector-platform/approvals/{vid}/status` | 查询审批状态 | FR-031 |
| 42 | | | GET | `/service/open/v2/connector-platform/approver-configs` | 查询审批人配置列表 | FR-032 |
| 43 | | | PUT | `/service/open/v2/connector-platform/approver-configs` | 更新审批人配置 | FR-032 |
| 44 | | **安全配置** | GET | `/service/open/v2/connector-platform/admin/app-whitelist` | 查询应用白名单列表 | FR-045 |
| 45 | | | POST | `/service/open/v2/connector-platform/admin/app-whitelist` | 添加应用到白名单 | FR-045 |
| 46 | | | DELETE | `/service/open/v2/connector-platform/admin/app-whitelist/{appId}` | 移出白名单 | FR-045 |
| 47 | connector-api | **运行时** | POST | `/api/v1/trigger/flow/{flowId}` | HTTP 触发连接流 | G11 |
| 48 | | | POST | `/api/v1/debug/execute` | 调试触发（同步执行） | FR-041 |
