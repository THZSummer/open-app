...
**关键需求**:
- 应用信息查询（AppID → 应用详情）
- 成员信息查询（AppID → 成员列表/角色）
- 应用身份认证接口（供能力方校验调用方身份）
