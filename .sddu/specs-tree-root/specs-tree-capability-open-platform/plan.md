...
| API 权限申请 | FR-016~FR-018 | 2 | 消费方 | 本文档详细设计 |
| 事件权限申请 | FR-019~FR-021 | 2 | 消费方 | 本文档详细设计 |
| 回调权限申请 | FR-022~FR-024 | 2 | 消费方 | 本文档详细设计 |
| 审批管理 | FR-025~FR-027 | 3 | 运营方/审批人 | 本文档详细设计 |
| Scope 用户授权 | FR-031 | 1 | 用户 | 按 `/front/README.md` 执行 |
| 应用管理 | FR-016相关 | 1 | 三方应用人员 | 按 `/front/README.md` 执行 |
| **总计** | **FR-001~FR-031** | **23** | - | - |
