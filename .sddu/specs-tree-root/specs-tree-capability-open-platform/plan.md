...
| 页面模块 | 对应功能 | 使用角色 | 设计流程 |
|----------|----------|----------|----------|
| **分类管理** | 分类树管理、责任人配置 | 运营方 | 本文档详细设计 |
| **API 管理** | API 注册、编辑、删除 | 分类责任人 | 本文档详细设计 |
| **事件管理** | 事件注册、订阅配置 | 分类责任人 | 本文档详细设计 |
| **回调管理** | 回调注册、订阅配置 | 分类责任人 | 本文档详细设计 |
| **权限申请** | 权限树浏览、权限申请 | 消费方 | 本文档详细设计 |
| **审批中心** | 待审批列表、审批操作 | 审批人 | 本文档详细设计 |
| **Scope 授权** | 用户授权管理 | 用户 | 按 `/front/README.md` 执行 |
| **应用管理** | 三方应用管理 | 三方应用人员 | 按 `/front/README.md` 执行 |
