...
| FR | 名称 | 描述 | 验收标准 |
|----|------|------|---------|
| FR-008 | 事件权限列表查看 | 分组责任人查看本分组已注册的事件列表及状态 | • 列表展示：**事件名称**、**Scope**、**Topic**、**分类**、**状态**<br/>• 支持操作：查看文档、复制审批地址、撤回审核（审核中） |
...
| FR | 名称 | 描述 | 验收标准 |
|----|------|------|---------|
| FR-015 | 应用事件列表查看与配置 | 消费方查看事件订阅状态，**获批后配置消费通道** | • 列表展示：**事件名称**、**Topic**、**认证方式**、**状态**（审核中/已授权等）<br/>• **获批权限支持配置消费通道**（WebHook URL、WebSocket Token 等）<br/>• 支持修改/更新通道配置 |
