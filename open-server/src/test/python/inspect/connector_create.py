...
request("POST", "/connectors", {"nameEn": "Test", "connectorType": 1})

# connectorType 非法
print("=== IT-003: connectorType=99 ===")
request("POST", "/connectors", {"nameCn": "测试", "nameEn": "Test", "connectorType": 99})

# nameCn 超长
print("=== IT-004: nameCn >500 ===")
request("POST", "/connectors", {"nameCn": "a"*501, "nameEn": "Test", "connectorType": 1})
