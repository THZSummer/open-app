...
try:
    print("=== IT-010: 正常查询 ===")
    request("GET", f"/service/open/v2/connectors/{snow_id}")

    print("=== IT-011: connectorId 不存在 ===")
    request("GET", "/service/open/v2/connectors/999999999999999999")

    print("=== IT-012: 雪花ID为string类型 ===")
    resp = request("GET", f"/service/open/v2/connectors/{snow_id}")
finally:
