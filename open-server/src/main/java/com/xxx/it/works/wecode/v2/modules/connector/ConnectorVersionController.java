...
public class ConnectorVersionController {
    ...
    public ApiResponse<?> createDraft(
        ...
        return connectorVersionService.createDraft(connectorId, appId);
    }
    ...
    public ApiResponse<List<ConnectorVersionListResponse>> getVersionList(
            @RequestHeader("X-App-Id") Long appId,
            @Parameter(description = "连接器ID") @PathVariable Long connectorId,
        ...
        return connectorVersionService.getVersionList(connectorId, status, appId);
    }
    ...
    public ApiResponse<ConnectorVersionDetailResponse> getVersionDetail(
            @RequestHeader("X-App-Id") Long appId,
            @Parameter(description = "连接器ID") @PathVariable Long connectorId,
        ...
        return connectorVersionService.getVersionDetail(connectorId, versionId, appId);
    }
    ...
    public ApiResponse<?> updateDraft(
        ...
        return connectorVersionService.updateDraft(connectorId, versionId, request.getConnectionConfig(), appId);
    }
    ...
    public ApiResponse<?> publish(
        ...
        return connectorVersionService.publish(connectorId, versionId, appId);
    }
    ...
    public ApiResponse<?> copyToDraft(
        ...
        return connectorVersionService.copyToDraft(connectorId, versionId, appId);
    }
    ...
    public ApiResponse<?> invalidateVersion(
        ...
        return connectorVersionService.invalidateVersion(connectorId, versionId, appId);
    }
    ...
    public ApiResponse<?> recoverVersion(
        ...
        return connectorVersionService.recoverVersion(connectorId, versionId, appId);
    }
    ...
    public ApiResponse<Void> deleteVersion(
        ...
        return connectorVersionService.deleteVersion(connectorId, versionId, appId);
    }
}
