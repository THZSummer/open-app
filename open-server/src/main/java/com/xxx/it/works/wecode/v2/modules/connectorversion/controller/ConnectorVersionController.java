...
public class ConnectorVersionController {
    ...
    public ApiResponse<?> createDraft(
        ...
        return connectorVersionService.createDraft(connectorId);
    }
    ...
    public ApiResponse<List<ConnectorVersionListResponse>> getVersionList(
        ...
        return connectorVersionService.getVersionList(connectorId, status);
    }
    ...
    public ApiResponse<ConnectorVersionDetailResponse> getVersionDetail(
        ...
        return connectorVersionService.getVersionDetail(connectorId, versionId);
    }
    ...
    public ApiResponse<?> updateDraft(
        ...
        return connectorVersionService.updateDraft(connectorId, versionId, request.getConnectionConfig().toString());
    }
    ...
    public ApiResponse<?> publish(
        ...
        return connectorVersionService.publish(connectorId, versionId);
    }
    ...
    public ApiResponse<?> copyToDraft(
        ...
        return connectorVersionService.copyToDraft(connectorId, versionId);
    }
    ...
    public ApiResponse<?> invalidateVersion(
        ...
        return connectorVersionService.invalidateVersion(connectorId, versionId);
    }
    ...
    public ApiResponse<?> recoverVersion(
        ...
        return connectorVersionService.recoverVersion(connectorId, versionId);
    }
    ...
    public ApiResponse<Void> deleteVersion(
        ...
        return connectorVersionService.deleteVersion(connectorId, versionId);
    }
}
