...
export const mockApprovals = [
  ...
  },
  {
    ...
    currentNode: 1,
    combinedNodes: [
      { type: 'approver', userId: 'event_admin', userName: '事件管理员', order: 1, level: 'scene', status: 0 },
  ...
  },
  {
    ...
    currentNode: 2,
    combinedNodes: [
      { type: 'approver', userId: 'api_admin', userName: 'API管理员', order: 1, level: 'scene', status: 0 },
      { type: 'approver', userId: 'admin002', userName: '平台管理员', order: 2, level: 'global', status: 0 }
    ],
...
export const mockMyApprovals = [
  {
    ...
    currentNode: 3,
    combinedNodes: [
      { type: 'approver', userId: 'order_admin', userName: '订单管理员', order: 1, level: 'resource', status: 0 },
      { type: 'approver', userId: 'perm_admin', userName: '权限管理员', order: 2, level: 'scene', status: 0 },
      { type: 'approver', userId: 'admin001', userName: '系统管理员', order: 3, level: 'global', status: 0 }
    ],
    createTime: '2026-04-01 10:00:00',
  },
  {
    ...
    currentNode: 1,
    combinedNodes: [
      { type: 'approver', userId: 'callback_admin', userName: '回调管理员', order: 1, level: 'scene', status: 2 },
      { type: 'approver', userId: 'admin001', userName: '系统管理员', order: 2, level: 'global', status: null }
    ],
