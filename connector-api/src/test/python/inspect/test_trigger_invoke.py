    ...
    "data": {
        ...
        "output": {
            ...
            "body": {
                "type": "object",
                "properties": {
                    "code":               {"type": "number", "value": "${$.node.node_connector.output.body.code}"},
                    "message":            {"type": "string",  "value": "${$.node.node_connector.output.body.message}"},
                    "searchKeyword":      {"type": "string",  "value": "${$.node.node_connector.output.body.data.keyword}"},
                    "searchPage":         {"type": "number", "value": "${$.node.node_connector.output.body.data.page}"},
                    "searchSize":         {"type": "number", "value": "${$.node.node_connector.output.body.data.size}"},
                    "totalCount":         {"type": "number", "value": "${$.node.node_connector.output.body.data.total}"},
                    "firstItemId":        {"type": "string",  "value": "${$.node.node_connector.output.body.data.items[0].id}"},
                    "firstItemName":      {"type": "string",  "value": "${$.node.node_connector.output.body.data.items[0].name}"},
                    "firstItemScore":     {"type": "number",  "value": "${$.node.node_connector.output.body.data.items[0].score}"},
                    "firstItemFirstTag":  {"type": "string",  "value": "${$.node.node_connector.output.body.data.items[0].tags[0]}"},
                    "firstItemDetailUrl": {"type": "string",  "value": "${$.node.node_connector.output.body.data.items[0].detail.url}"},
