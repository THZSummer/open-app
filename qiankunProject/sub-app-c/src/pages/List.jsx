...
const mockData = [
  ...
  { id: 3, name: '任务三', status: '待开始' }
];

// 页面内联样式
const styles = {
  container: { padding: '20px' },
  title: { color: '#52c41a', marginBottom: '16px' },
  table: { width: '100%', borderCollapse: 'collapse', marginTop: '16px' },
  th: { border: '1px solid #ddd', padding: '8px 12px', background: '#fafafa', textAlign: 'left' },
  td: { border: '1px solid #ddd', padding: '8px 12px' },
  btn: { padding: '4px 12px', marginRight: '8px', cursor: 'pointer', border: '1px solid #52c41a', background: '#52c41a', color: '#fff', borderRadius: '4px' }
};
...
function List() {
  ...
  return (
    <div style={styles.container}>
      <h2 style={styles.title}>子应用 C - 列表页</h2>
