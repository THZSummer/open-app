...
const styles = {
  ...
  btn: { padding: '4px 12px', cursor: 'pointer', border: '1px solid #52c41a', background: '#52c41a', color: '#fff', borderRadius: '4px', marginTop: '16px' }
};
...
function Detail() {
  ...
  return (
    <div style={styles.container}>
      <h2 style={styles.title}>子应用 C - 详情页</h2>
